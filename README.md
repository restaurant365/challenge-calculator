...
1. Support a maximum of 2 numbers
	a. Use a comma delimited format e.g. "1,20" will return 21
	b. Invalid/Missing numbers should be converted to 0 e.g. "" will return 0; "5,tytyt" will return 5
...
6. Support a single custom delimiter
	a. use the format: "//{delimiter}\n{numbers}" e.g. "//;\n2;5" will return 7
	b. all existing appropriate scenarios should still be supported
7. Support delimiters of any length
	a. use the format: "//[{delimiter}]\n{numbers}" e.g. "//[***]\n11***22***33" will return 66
	b. all existing appropriate scenarios should still be supported
8. Support multiple delimiters
	a. use the format: "//[{delimiter1}][{delimiter2}]...\n{numbers}" e.g. "//[*][!!][rrr]\n11rrr22*33!!44" will return 110
	b. all existing appropriate scenarios should still be supported
